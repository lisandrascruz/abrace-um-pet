...
public class Imagens {
	public static void imagemLogin(JLabel label) {
		try {
			label.setIcon(new ImageIcon(new File("imagens/login.png")
					.getCanonicalPath()));
	...
	public static void imagemCadastroUsuario(JButton button) {
		try {
			button.setIcon(new ImageIcon(new File("imagens/cadastro.png")
					.getCanonicalPath()));
		} catch (IOException e1) {
			e1.printStackTrace();
		}
	...
	public static void imagemCadastroAdotante(JLabel label) {
		try {
			label.setIcon(new ImageIcon(new File("imagens/cadastroAdotante.png")
					.getCanonicalPath()));
		} catch (IOException e1) {
			e1.printStackTrace();
		}
