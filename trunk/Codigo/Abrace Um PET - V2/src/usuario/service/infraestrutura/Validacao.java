...
public class Validacao {
	...
	public boolean validarConsultarLoginBD(String login, String senha) {
		boolean valido = true;

		if (usuarioDAO.consultarUsuario(login, senha)) {
			JOptionPane.showMessageDialog(null, "Usuário já cadastrado! Digite outro login.",
					"ERROR", 0);
			valido = true;
		} else {
			valido = false;
